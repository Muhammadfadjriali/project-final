...
public class Peminjaman extends Main {
    ...
    public void cetak(int idMahasiswa, Mahasiswa Mahasiswa, Buku buku) {
        int idBuku = getIdBuku(idMahasiswa);
        int banyak = getBanyak(idMahasiswa);
        System.out.println("id mahasiswa: " + idMahasiswa);
        System.out.println("Nama buku          : " + idMahasiswa);
        System.out.println("Banyak       : " + idMahasiswa);
    }
    ...
    public void cetak_data() {
        ...
        try {
            ...
            output.println("id mahasiswa: " + idMahasiswa);
            output.println("Nama buku          : " + idMahasiswa);
            output.println("Banyak       : " + idMahasiswa);
            output.close();
